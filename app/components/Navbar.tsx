...
export default function Navbar() {
  return (
    <nav className='bg-black mx-auto max-w-[1000px] z-50'>
      {" "}
      {/*nav max width 44.75rem or 716px*/}
      <div className='prose prose-xl mx-auto max-w-[1110px] flex mt-6 justify-between flex-col sm:flex-row z-50'>
        <h1 className='text-3xl font-bold text-white grid z-50 place-content-center mb-2 md:mb-0'>
          <Link
            href='/'
        ...
        <div className='flex flex-row justify-center sm:justify-evenly align-middle gap-4 text-white text-4xl lg:text-5xl z-50'>
          <Link
            href='https://github.com/saram7619'
          ...
          <Link
            href='https://www.frontendmentor.io/profile/saram7619'
            className='text-white/90 hover:text-white'>
            <svg
              xmlns='http://www.w3.org/2000/svg'
              width='26'
              ...
              role='img'>
              {/*<title id='socialFrontendMentor'>FrontendMentor</title>*/}
              <path
                fill='#FFF'
