...
export default function Footer() {
  return (
    <nav className='bg-gray p-4 mx-auto max-w-[1110px] bottom-0 static'>
      {" "}
      <div className='prose prose-xl mx-auto  max-w-[1110px] flex justify-between flex-col sm:flex-row'>
        ...
        <div className='flex flex-row justify-center sm:justify-evenly align-middle gap-4 text-white text-4xl lg:text-5xl'>
          <Link href='https://github.com/saram7619' className='text-white/90 hover:text-green'>
            <svg
          ...
          <Link href='https://www.frontendmentor.io/profile/saram7619' className='text-white/90 hover:text-green'>
            <svg
              xmlns='http://www.w3.org/2000/svg'
              width='26'
              height='24'
          ...
          <Link href='https://www.linkedin.com/in/sara-mc-clelland-747361255' className='text-white/90 hover:text-green'>
            <svg
              xmlns='http://www.w3.org/2000/svg'
              width='25'
              height='24'
